...
def test_compile():
    ...
    _res = _sp.run("g++ -O1 -Wall -Wextra -Werror -fsanitize=bounds -fno-sanitize-recover=bounds -D_GLIBCXX_DEBUG valid-parentheses.cpp -o valid-parentheses", shell=True, capture_output=True, text=True)
