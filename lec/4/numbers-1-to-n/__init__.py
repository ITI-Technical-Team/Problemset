...
def test_compile():
    ...
    _res = _sp.run("g++ -O1 -Wall -Wextra -Werror -fsanitize=bounds -fno-sanitize-recover=bounds -D_GLIBCXX_DEBUG numbers-1-to-n.cpp -o numbers-1-to-n", shell=True, capture_output=True, text=True)
