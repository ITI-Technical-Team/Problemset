...
def test_compile():
    ...
    _res = _sp.run("g++ -O1 -Wall -Wextra -Werror -fsanitize=bounds -fno-sanitize-recover=bounds -D_GLIBCXX_DEBUG summation.cpp -o summation", shell=True, capture_output=True, text=True)
