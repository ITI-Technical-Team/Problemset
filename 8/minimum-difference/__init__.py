...
def test_compile():
    ...
    check50.run("g++ -O1 -Wall -Wextra -Werror -fsanitize=bounds -fno-sanitize-recover=bounds -D_GLIBCXX_DEBUG minimum-difference.cpp -o minimum-difference 2>&1").exit(0)
